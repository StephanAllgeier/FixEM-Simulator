...
def get_samples_and_labels(settings):
    ...
    elif settings['data'] == 'FEM':
        print('Fixational Eye Movement Task selected.')
        samples, pdf, labels = get_data('FEM', {})
    ...
    settings['num_samples'] = samples['train'].shape[0] + samples['vali'].shape[0] + samples['test'].shape[0] #TODO Unterschied zwischen num_samples und num_signals
