...
class LSTMCell(RNNCell):
  ...
  def __call__(self, inputs, state, scope=None):
    ...
    #if input_size.value is None: #TODO: Hier wird ein Fehler generiert
...
def _linear(args, output_size, bias, bias_start=0.0, scope=None):
  ...
  """
  if args is None or (nest.is_sequence_or_composite(args) and not args): #TODO: nest.is_sequence wurde ersetzt durch nest.is_sequence_or_composite. An beiden Stellen.
  ...
  for shape in shapes:
    ...
    #TODO: Hier wurden von mir Änderungen vorgenommen, weil shape[1] schon int ist
    ''' 
