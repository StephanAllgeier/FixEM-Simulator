...
def Versuchsplanung():
    ...
    for folder in folder_names:
        ...
        for combination in all_combinations:
            ...
            for i in range(n):
                ...
                micsac_amp, intermic_duration, num_of_micsac = RandomWalkBased.RandomWalk.randomWalk(
                    ...
                    relaxation_rate=relaxation_rate, hc=hc, duration=30, sampling_frequency=500,
                    number_id=i, folderpath=folderpath)
        ...
        partially_df.to_excel(rf"C:\Users\uvuik\bwSyncShare\Documents\Versuchsplanung Mathematisches Modell\AuswertungErgebnisse\Teiltabellen\0.4 vals\{filename_excel_partially}",index=False)
        partially_df.to_csv(rf"C:\Users\uvuik\bwSyncShare\Documents\Versuchsplanung Mathematisches Modell\AuswertungErgebnisse\Teiltabellen\0.4 vals\{filename_csv_partially}",index=False)
